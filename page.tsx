    ...
    return (
      <nav className="flex justify-between items-center bg-gray-900 text-white p-4 sm:p-6 lg:p-8">
        <div className="flex items-center gap-2">
          ...
          <span className="text-2xl font-bold">Caselist</span>
        </div>
        <div className="flex flex-grow justify-end space-x-4 items-center">
          <div className="hidden sm:flex space-x-4">
            <button onClick={() => setCurrentPage('home')} className="hover:text-gray-300 transition duration-150 ease-in-out">Home</button>
            <button onClick={() => setCurrentPage('dashboard')} className="hover:text-gray-300 transition duration-150 ease-in-out">Dashboard</button>
            <button onClick={() => setCurrentPage('services')} className="hover:text-gray-300 transition duration-150 ease-in-out">Services</button>
          </div>
